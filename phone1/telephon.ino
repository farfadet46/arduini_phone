...
const int resetBtn = 12; //appui sur le BTN reset phisique
  ...
  if(key=='0'||key=='1'||key=='2'||key=='3'||key=='4'||key=='5'||key=='6'||key=='7'||key=='8'||key=='9'){
   ...
   // PLAYED_A_SONG = false;
    ...
    if(CODE_COUNTER==4){
      ...
      delay(250); //laisser le temps de finir la sonnerie de la dernière touche pressée
